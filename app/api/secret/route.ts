...
export async function GET(req: Request) {
  try {
    ...
    // Since we don't have a reverse DB query for subscriptions yet, we fetch recent cars
    // and run them through our match logic
    ...
    for (const car of recentCars) {
      // In-memory match using the same logic the webhook uses
    ...
    console.error("Secret Matches API Error:", error);
